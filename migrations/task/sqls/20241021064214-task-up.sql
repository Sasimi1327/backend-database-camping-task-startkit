...
FROM
  "CREDIT_PURCHASE" c1
  INNER JOIN "CREDIT_PACKAGE" c2 ON c1.credit_package_id = c2.id
WHERE
  c1.created_at BETWEEN '2024-12-01 00:00:00'
  AND '2024-12-31 00:00:00'
GROUP BY
  c2.name;
...
FROM
  "CREDIT_PURCHASE"
WHERE
  purchase_at  BETWEEN '2024-12-01 00:00:00'
  AND '2024-12-31 00:00:00';
...
FROM
  "COURSE_BOOKING"
WHERE
  created_at BETWEEN '2024-12-01 00:00:00'
  AND '2024-12-31 00:00:00'
  AND status != '課程已取消';